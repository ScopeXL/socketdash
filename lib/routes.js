...
module.exports = function(app) {
    ...
    app.get('/assets/js/:file', function(req, res) {
        ...
        switch (file) {
            ...
            case 'moment':
                ...
                break;
            case 'highstock':
                res.sendFile('node_modules/highcharts/highstock.js', { root: dir });
                break;
            default:
    ...
    // JavaScript located in a folder
    app.get('/assets/js/:folder/:file', function(req, res) {
        var folder = req.params.folder,
            file = req.params.file;

        res.sendFile('js/' + folder + '/' + file, { root: dir });
    });
